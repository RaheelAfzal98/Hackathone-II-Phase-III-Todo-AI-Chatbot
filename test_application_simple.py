...
def test_api_docs():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"[ERROR] API Documentation returned status code: {response.status_code}")
            return False
    except Exception as e:
        print(f"[ERROR] API Documentation test failed: {e}")
        return False
...
def main():
    ...
    if all_tests_passed:
        ...
        print("[ERROR] Some services are not running correctly.")
